...
In an effort to contribute to eachothers learning as a whole, Molecool team members brainstormed independently in order to tackle the more challenging aspects of the project, but worked as a group. Greg did questions 3 & 5, Jess did 1,4, & 7, Julia did 2 & 8, and Stephanie did question 6. We convened regularly to discuss questions or to troubleshoot and enjoyed working as a team. A special thanks to Professor Kenaley for the project design.
