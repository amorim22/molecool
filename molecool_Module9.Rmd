...
In this project, we will explore available resources like eBird and NOAA’s National Climatic Data Center’s API in order to observe and study the effects of changes in local weather and environmental aspects linked to climate change and how these affect the migration of TGMs. 
