library(tidyverse)
dat.f <- list.files(pattern = "Greg_active.csv, Greg_Couch.csv, Steph_active.csv, Steph_Couch.csv, Jess_active.csv, Jess_Couch.csv, Julia_active.csv, Julia_Couch.csv,") #find the files
